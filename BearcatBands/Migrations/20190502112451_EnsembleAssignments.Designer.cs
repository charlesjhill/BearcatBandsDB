...
namespace BearcatBands.Migrations
{
    ...
    [Migration("20190502112451_EnsembleAssignments")]
    partial class EnsembleAssignments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BearcatBands.Models.EnsembleAssignment", b =>
                {
                    b.Property<int>("EnsembleID");

                    b.Property<int>("InstructorID");

                    b.HasKey("EnsembleID", "InstructorID");

                    b.HasIndex("InstructorID");

                    b.ToTable("EnsembleAssignments");
                });

            modelBuilder.Entity("BearcatBands.Models.Instructor", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BearcatBands.Models.EnsembleAssignment", b =>
                {
                    b.HasOne("BearcatBands.Models.Ensemble", "Ensemble")
                        .WithMany("EnsembleAssignments")
                        .HasForeignKey("EnsembleID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BearcatBands.Models.Instructor", "Instructor")
                        .WithMany("EnsembleAssignments")
